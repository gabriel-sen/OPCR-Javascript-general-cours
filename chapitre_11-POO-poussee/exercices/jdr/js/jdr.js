var Personnage = {
    ...
    attaquer: function (cible) {
        if (this.sante > 0) {
            ...
            if (cible.sante > 0) {
                console.log(cible.nom + " a encore " + cible.sante + " points de vie, " + this.pieceOr + " pieces d'or et " + this.clef + " clés");
            } else {
                cible.sante = 0;
                console.log(cible.nom + " est mort !");
                console.log( joueur1.nom + " et " + joueur2.nom + " récupérent chacuns : " + cible.pieceOr + " pieces d'or sur  "+ " et " + cible.clef + " clef sur  "+ cible.nom );
                this.pieceOr = cible.pieceOr + this.pieceOr;
                cible.pieceOr = 0
            }
        } else {
...
Joueur.decrire = function () {
    var description = this.nom + " a " + this.sante + " points de vie, " +
        this.force + " en force et " + this.xp + " points d'expérience " + this.pieceOr + " pieces d'or " + this.clef + " clés" ;
    return description;
};
...
Adversaire.initAdversaire = function (nom, sante, force, race, valeur, pieceOr, clef) {
    this.initPerso(nom, sante, force);
    this.race = race;
    this.valeur = valeur;
    this.pieceOr = 10;
